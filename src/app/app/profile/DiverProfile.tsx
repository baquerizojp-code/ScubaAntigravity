        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setForm((f) => ({ ...f, certification: v }))}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="space-y-1.5">
            ...
            <div className="space-y-3">
              <div className="space-y-1.5">
                <Label htmlFor="emergency_contact_name" className="text-xs text-muted-foreground">
                  {t('diver.profile.emergencyName')}
                </Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label htmlFor="emergency_contact_phone" className="text-xs text-muted-foreground">
                  {t('diver.profile.emergencyPhone')}
                </Label>
                <PhoneInput
