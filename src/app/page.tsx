...
import { Search, CalendarCheck, Users, Settings, ChevronRight, Fish, MapPin } from 'lucide-react';
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <h2 className="text-4xl sm:text-5xl font-headline font-extrabold text-foreground tracking-tight leading-tight">
                {t('landing.connection.title1')} <br className="hidden sm:block" />
                {t('landing.connection.title2')}
              </h2>
              <p className="text-muted-foreground text-lg sm:text-xl leading-relaxed">{t('landing.cta.subtitle')}</p>

              <div className="flex flex-col items-start gap-4 pt-4">
                <Link href="/explore" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-primary text-primary-foreground hover:brightness-110 font-bold font-headline px-8 py-6 sm:py-7 rounded-full shadow-lg shadow-primary/20 transition-all text-base"
                  >
                ...
                <Link
                  href="/register-center"
                  className="text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center gap-1 ml-1"
                >
