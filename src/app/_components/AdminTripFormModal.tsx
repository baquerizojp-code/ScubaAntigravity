  ...
  useEffect(() => {
    if (trip) {
      setForm({
        ...
        price_usd: Number(trip.price_usd),
        difficulty: trip.difficulty || '',
        min_certification: trip.min_certification || '',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                max={new Date(Date.now() + MAX_FUTURE_TRIP_DAYS * 86400000).toISOString().split('T')[0]}
            ...
            <div>
              ...
              <Input
                ...
                min={0}
                step={0.01}
                value={form.price_usd === 0 ? '' : form.price_usd}
