  ...
  return (
    <div className="relative" ref={ref}>
      <Button
        ...
        className={`relative min-h-[44px] min-w-[44px] rounded-full ${className || ''}`}
                ...
                <div
                  ...
                  onClick={() => {
                    ...
                    if (n.type === 'center_approved' || n.type === 'center_rejected') {
                      ...
                      isDiveCenter &&
                      (n.type === 'new_booking' || n.type === 'cancellation_request' || n.type === 'booking_cancelled')
                    ) {
                      router.push('/admin/bookings');
                    } else if (
                      (n.type === 'booking_confirmed' || n.type === 'booking_rejected' || n.type === 'new_trip') &&
                      n.trip_id
                    ) {
                      router.push(`/app/trip/${n.trip_id}`);
                    }
                  }}
                >
